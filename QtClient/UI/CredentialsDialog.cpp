...
{
	setUpGUI();
	setWindowTitle(tr("User Login, try again"));
	setModal(true);
}

void CredentialsDialog::setUpGUI() {
	// set up the layout
...
void CredentialsDialog::setUsername(QString& username) {
	bool found = false;
...
void CredentialsDialog::setPassword(QString& password) {
	editPassword->setText(password);
}

void CredentialsDialog::slotAcceptLogin() {
...
void CredentialsDialog::setUsernamesList(const QStringList& usernames) {
